...
export default function Documents() {
  const [activeTab, setActiveTab] =
    useState<"requests" | "submissions">("requests");
...
const deleteDocumentRequest = async (requestId: string) => {
  const url = `${API_URL}/documents/requests/${requestId}`;
  ...
  const sendReminder = (
    ...
    const participantName =
      request.participant &&
      typeof request.participant === "object"
  ...
  const pendingUpload = requests.filter(
    (request) =>
      request.status === "pending"
  ).length;
                        ...
                        {request.status ===
                          ...
                          <div className="flex shrink-0 items-center gap-2">
                            <button
                              ...
                              className="flex items-center justify-center gap-2 rounded-full bg-[#edf1ff] px-5 py-3 text-sm font-medium text-[#5870dc] transition hover:bg-[#e3e8ff]"
                            >
                              <Send size={16} />
                              Send Reminder
                            </button>
                            ...
                            <button
                              ...
                              className="flex items-center justify-center gap-2 rounded-full bg-[#fff0f0] px-5 py-3 text-sm font-medium text-[#e05252] transition hover:bg-[#ffe5e5]"
                            >
                              <XCircle size={16} />
                              Delete
                            </button>
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white p-8 shadow-2xl">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#8b8daa]">
                  Select an event and participant,
